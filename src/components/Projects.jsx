...
const projects = [
  {
    id: 1,
    title: 'Análisis de Cohortes e-commerce',
    description: 'Este proyecto transforma datos transaccionales crudos de Olist (E-Commerce brasileño) en una estrategia de segmentación de clientes accionable utilizando la metodología RFM (Recencia, Frecuencia, Monetización).',
    technologies: ['Python', 'Pandas', 'Matplotly', 'Numpy', 'Excel', 'Jupyter'],
    image: 'sales',
    github: 'https://github.com/Caero-Nahuel/Proyecto-analisis-de-cohortes-ecommerce',
  },
  {
    id: 2,
    title: 'Análisis de CHURN - Telecom',
    description: 'Este proyecto realiza un Análisis Exploratorio de Datos (EDA) sobre una base de clientes de una empresa de telecomunicaciones, con el objetivo de comprender los patrones de comportamiento asociados al abandono del servicio (churn).',
    technologies: ['Python', 'Plotly', 'Seaborn', 'Pandas', 'Jupyter'],
    image: 'financial',
    github: 'https://github.com/Caero-Nahuel/Analisis-de-CHURN-de-Clientes-Telecom-Industry',
  },
  {
    id: 3,
